...
class FullDateCollectionViewCell: UICollectionViewCell {
    ...
    func populateItem(date: Date, highlightColor: UIColor, darkColor: UIColor, locale: Locale) {
        ...
        mdateFormatter.locale = Locale(identifier: "fa_IR")
        mdateFormatter.calendar = Calendar.init(identifier: .persian)
        ...
        numberFormatter.calendar = Calendar.init(identifier: .persian)
