...
@objc public class DateTimePicker: UIView {
    ...
    public var cancelButtonTitle = "بستن" {
        didSet {
    ...
    internal var calendar: Calendar = Calendar.init(identifier: .persian)
    ...
    private func configureView() {
        ...
        cancelButton.setTitle(cancelButtonTitle, for: .normal)
        cancelButton.titleLabel?.font = UIFont(name: YEKAN_WEB_FONT, size: 18)
        cancelButton.setTitleColor(darkColor.withAlphaComponent(0.5), for: .normal)
        ...
        todayButton.titleLabel?.font = UIFont(name: YEKAN_WEB_FONT, size: 18)
        ...
        doneButton.titleLabel?.font = UIFont(name: YEKAN_WEB_FONT, size: 20)
        ...
        colonLabel1.text = ":"
        colonLabel1.font = UIFont(name: YEKAN_WEB_FONT, size: 18)
        colonLabel1.textColor = highlightColor
        ...
        colonLabel2.text = ":"
        colonLabel2.font = UIFont(name: YEKAN_WEB_FONT, size: 18)
        colonLabel2.textColor = highlightColor
